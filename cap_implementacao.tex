...
O filtro de dados remove os ciclos de movimento incompletos, ou com problemas na aquisição dos dados, como explicado na Seção~\ref{section:filtro_dados}. Nessa etapa, os ciclos são: normalizados, escalonados e rótulos do usuário (\textit{labels}). 
