...
%\includepdf{atadefesareduzida.pdf}
\includepdf[pages=-,scale=.9,pagecommand={}]{atadefesatrat.pdf}
...
\input{cap3-abordagemjogueme}
\input{cap4_arquitetura}	
\input{cap5-avaliacao}
