...
Na busca por motivar os usuários a fornecer seus dados motores, foi identificado que os jogos eletrônicos encontram-se presentes na rotina diária de 26\% da população americana acima dos 50 anos~\cite{esa2016}. Com base nesse número, têm-se um público de jogadores idosos que podem ser beneficiados por uma abordagem de monitoramento de dados de saúde embutida num jogo eletrônico. Aliado a esse estudo, foi encontrado, jogos voltados para o público idoso aplicados à melhoria do estado de saúde, tais como jogos para a persuasão da prática de atividades físicas~\cite{seriousgameolder2015} e jogos para a melhoria das capacidades físicas e cognitivas~\cite{arntzen2011}. 
...
%Ambient videogames can be used for frequent continuous monitoring of older adults in order to detect early signs of frailty. In this paper we propose a general architecture for health monitoring through ambient videogames and illustrate its instantiation with the development of two ambient casual games that have been designed to measure arm muscle strength utilizing a custom-designed interaction device that provides a natural user interface for the games. We conducted a formative evaluation of the games with 5 older adults to assess ease of use and their interest in playing them. We compare the results of traditional measures of muscle strength using a clinical dynamometer with those obtained using the videogame. We compare the results of traditional measures of muscle strength using a clinical dynamometer with those obtained using the videogame In this paper we presented the design and development of two casual ambient games that involved the use of a prototype of an embodied video interface. We found that this device accurately measures the grip strength to assist in the detection of early signs of dynapenia.


%~\cite{cloudrehabi2014}
%VII. CONCLUSION
% Preliminary experiments validate its potential in training healthy subject to perform exercise motions emulating the physical rehabilitation process.
%This paper introduced a new cloud-based physical telerehabilitation system. Due to readily available features in cloud implementations, the systems are more reliable, flexible and accessible than conventional rehabilitation and telerehabilitation systems. More importantly, the proposed system enables therapists to create specific motion models with their knowledge about their patients, which undoubtedly contributes to the rehabilitation effectiveness. In addition, by following the model motion, patients are
...
%Por este motivo, é que na abordagem desta tese, foi utilizado um dispositivo comercial e de baixo custo como o Ms-Kinnect.

%Ambient videogames can be used for frequent continuous monitoring of older adults in order to detect early signs of frailty. In this paper we propose a general architecture for health monitoring through ambient videogames and illustrate its instantiation with the development of two ambient casual games that have been designed to measure arm muscle strength utilizing a custom-designed interaction device that provides a natural user interface for the games. We conducted a formative evaluation of the games with 5 older adults to assess ease of use and their interest in playing them. We compare the results of traditional measures of muscle strength using a clinical dynamometer with those obtained using the videogame. We compare the results of traditional measures of muscle strength using a clinical dynamometer with those obtained using the videogame In this paper we presented the design and development of two casual ambient games that involved the use of a prototype of an embodied video interface. We found that this device accurately measures the grip strength to assist in the detection of early signs of dynapenia.

Os jogos pervasivos móveis motivam a atividade física de forma mais direta, tais como \textit{Transe}, \textit{Feeding Yoshi} e  \textit{Nokia Wellness Diary and Sports Tracker}, que promovem a saúde com a prática de atividade física~\cite{seriousgameolder20154} e melhoram as condições de saúde por serem divertidos, imersivos e engajados. Para o público idoso, foram desenvolvidos diferentes jogos para a melhoria da saúde, como: sistemas para reabilitação motora dos idosos~\cite{cloudrehabi2014} e também para pacientes com~\ac{dp}~\cite{synnott_wiipd_2012,sacbespoke2014}. 
...
%Martinez-Manzanera \textit{et al.}~\cite{classifiersparkinson2014}, usou algoritmos evolucionários para reconhecer os movimentos característicos do~\cite{dp}. Ele usaram sensores de orientação para quantificar a bradicinesia. Utilizando um sensor de movimento (~\textit{Polhemus Patriot electromagnetic motion tracking}) anexado ao corpo dos usuários  

%whose probes were attached to the subject’s thumb and index finger while carrying out prescribed tasks. 
...
% além de motivar o usuário a exercê-los.

%O problema então está em como alcançar o equilíbrio entre necessidade de monitoramento e não-invasividade e, ainda mais, buscando aumentar a motivação.
