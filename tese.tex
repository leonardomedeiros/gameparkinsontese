...
%\input{cap-2-saude-conectada}
\input{cap3-fundamentacao}
%\input{cap3-para-reuso-jogos-monitoramento}
\input{cap4-arquitetura}
%\input{cap2-metodologia}
%\input{cap4-requisitos}
\input{cap_implementacao}	
%\input{cap4-gahme-process}
%\input{Processo de Desenvolvimento}
%\input{Arquitetura da Solucao}
%\input{cap5-identificacao_de_sintomas}
\input{cap6-avaliacao}
%\input{trabalhosfuturos}
...
\appendix
\input{apend_comite}
\input{apend3-entrevista-semi}
\input{apendice-diagnostico}
\input{questionario-gqm}
