...
\begin{frame}{Motivação para uso de jogos para monitoramento dos dados motores}
	\begin{block}{}
	\begin{itemize}[<+->]
	    \item Percentual expressivo de adultos e idosos que usam jogos em sua rotina diária (27\% acima dos 50 anos~\cite{});
...
Nos experimentos realizados, conseguimos demonstrar:
  \begin{itemize}
   ...
   \item Um percentual de 83\% dos usuários integrariam a a solução de monitoramento proposta em sua rotina diária.
  \end{itemize}
\end{block}
\end{frame}
