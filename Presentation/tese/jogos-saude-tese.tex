...
\begin{frame}{Jogos Aplicados à Saúde}
	...
	\begin{itemize}[<+->]
	    \item Jogos para a melhoria da saúde do idoso com: visado a reabilitação motora dos idosos~\cite{brox11} e para a reeducação motora da Doença de Parkinson (Parkinson)~\cite{atkinson2010,synnott_wiipd_2012,sacbespoke2014};
	    \item Jogos que utilizam sensores hápticos para quantificar a habilidade motora do paciente com Parkinson ~\cite{atkinson2010} .
	    \item Jogos para identificaram efeitos positivos para a reabilitação através do uso do jogo \textit{Wii Sports} e um potencial mecanismo de prevenção e reeducação motora com o uso do \textit{Wii Fit}
	    \item Jogos comerciais para prática de exercício físico com monitoramento dos sinais vitais(Batimento cardíaco)~\cite{Sinclair:2009:UVB:1515604.1515617}.
	\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}{Estudo Analítico de Caso-Controle: Identificação da Bradicinesia} 
    ...
    \begin{alertblock}{}
     Esta etapa da pesquisa foi pautada pelo protocolo de pesquisa avaliado pelo Comitê de Ética da UFCG (CAAE: 14408213.9.1001.5182)
    \end{alertblock}
\end{frame}
